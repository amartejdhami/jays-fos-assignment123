...
# Replacing 1536 bit safe prime to 4096 safe prime for DH key exchange
...
def create_dh_key():
    ...
    a = random.randint (0, int(prime)) #a is random generated number
    g = 2 #generator is 2
    # Returns (public, private)
    key = (pow(g, a)) % prime
    return (key, key) #returning public key and private key
